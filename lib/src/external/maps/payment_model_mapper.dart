...
class PaymentModelMapper extends PaymentModel {
  ...
  static PaymentModel fromMap(Map<String, dynamic> map) => PaymentModel(
  ...
  static String toJson(PaymentModel model) => json.encode(toMap(model));

  static PaymentModel fromJson(String source) => fromMap(json.decode(source));
}
