...
class HotelModelMapper {
  ...
  static HotelModel fromMap(Map<String, dynamic> map) => HotelModel(
        name: map['name'],
        city: map['city'],
        state: map['state'],
        country: map['country'],
  ...
  static String toJson(HotelModel model) => json.encode(toMap(model));

  static HotelModel fromJson(String source) => fromMap(json.decode(source));
}
