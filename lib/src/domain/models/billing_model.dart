...
class BillingModel {
  ...
  bool operator ==(Object o) {
    ...
    return o is BillingModel && o.clientId == clientId && o.type == type && o.primaryDocument == primaryDocument && o.secondaryDocument == secondaryDocument && o.name == name && o.birthDate == birthDate && o.email == email && o.gender == gender && o.address == address && listEquals(o.phones, phones);
  }

  @override
  int get hashCode {
    return clientId.hashCode ^ type.hashCode ^ primaryDocument.hashCode ^ secondaryDocument.hashCode ^ name.hashCode ^ birthDate.hashCode ^ email.hashCode ^ gender.hashCode ^ address.hashCode ^ phones.hashCode;
  }
